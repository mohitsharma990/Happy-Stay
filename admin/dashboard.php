...
<aside class="w-64 h-full basis-1/5"  aria-label="Sidebar">
   <div class="overflow-y-auto  py-4 px-3 h-full bg-gray-200 rounded dark:bg-gray-800">
      <ul class="space-y-2">
         <li>
            <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white bg-gray-100 ">
         ...
         <li>
            <a href="room.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
