                ...
                <div class="bg-white rounded shadow p-4">
                    <form >
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" name="name" class="form-control shadow-none" required disabled>
                        </div>
                        <div class="mt-3">
                            <label class="form-label" style="font-weight: 500;">Email</label>
                            <input type="text" name="email" class="form-control shadow-none" disabled>
                        </div>
                        <div class="mt-3">
                            <label class="form-label" style="font-weight: 500;">Subject</label>
                            <input type="text" name="sub" class="form-control shadow-none" disabled>
                        </div>
                        <div class="mt-3">
                            <label class="form-label" style="font-weight: 500;">Message</label>
                            <textarea class="form-control shadow-none" name="msg" rows="5" style="resize:none;" required disabled></textarea>
                        </div>
                        <input type="submit" name="sub_msg" class="btn text-white custom-bg mt-3" value="SEND" disabled>
                    </form>
                </div>
            </div>
        </div>
